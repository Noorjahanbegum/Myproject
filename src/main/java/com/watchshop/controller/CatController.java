...
import com.watchshop.dao.CategoryDao;
...
public class CatController {
	...
	public String delcat(@RequestParam("catid")int cd,Map <String,Object> model)
	{
	    model.put("ed", 0);
	    catDao.deletecat(cd);
	    
	    List catlist1=catDao.listCat();
		model.put("catlist", catlist1);
